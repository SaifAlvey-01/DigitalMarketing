        ...
        <div className="flex flex-col items-start justify-start max-w-[1180px] mb-[147px] mx-auto w-full">
            ...
            <div className="flex flex-col md:gap-10 gap-[110px] items-center justify-start w-full">
              <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-full">
                <div className="flex md:flex-1 flex-col items-start justify-start w-[46%] md:w-full">
                  ...
                  <Button
                    className="cursor-pointer hover:bg-[#f15a2b] font-medium min-w-[163px] mt-14 rounded-[15px] text-center text-sm"
                    color="indigo_A200"
                    size="xs"
                  >
                    Get in Touch
                ...
                <div className="flex justify-center items-center md:gap-5 ">
                  <div className="bg-gray-500 h-[550px] md:ml-[0] ml-[74px] rounded-[18px] sm:w-[150px] w-[400px]"></div>
                  <div className="bg-gray-500 h-[550px] ml-5 md:ml-[0] rounded-[18px] w-[150px]"></div>
                </div>
              </div>
          ...
          <div className="flex flex-col items-center justify-start mt-[239px] w-[91%] md:w-full">
            <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-full">
              <div className="bg-gray-500 h-[500px] rounded-[42px] w-[85%] "></div>
              <div className="flex flex-col items-start justify-start ml-24">
                ...
                <div className="h-[49px] flex items-center justify-center md:h-[98px] mt-[49px] pr-[9px] relative">
                  <div className="bg-indigo-A200 hover:bg-deep_orange-600 flex items-center justify-center h-[49px] rounded-[15px] w-[165px] my-auto px-10"></div>
                  <a
                    href="javascript:"
                    className="absolute h-max inset-y-[0] left-[22%] my-auto text-sm text-white-A700 tracking-[0.28px]"
                  >
                    <Text size="txtPoppinsMedium14" className="ml-2">
                      Learn More
                    </Text>
                  </a>
                </div>
          ...
          <div className="flex flex-col items-center justify-start md:ml-[0] ml-[93px] mt-[219px] w-[82%] md:w-full">
            <div className="flex flex-col items-center justify-start w-full">
              ...
              <div className="flex flex-row sm:gap-10 items-start justify-between  w-full">
                ...
                <div className="bg-gray-500 h-10  rotate-[180deg] rounded-[50%] w-10"></div>
              </div>
              <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between  w-[96%] md:w-full">
                ...
                <div className="flex flex-col items-center justify-start">
                  <div className="flex sm:flex-col flex-row sm:gap-10 items-start justify-between w-full">
                    ...
                    <div className="h-72 md:h-[265px] relative flex justify-center items-center w-[67%] sm:w-full">
                      ...
                      <Text
                        className="absolute bottom-[0] inset-x-[0] leading-[22.00px] ml-[-150px] text-center text-sm text-white-A700 w-[350px]"
            ...
            <div className="flex flex-col items-center justify-start w-full">
              ...
              <div className="gap-[39px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 items-center justify-between mt-[75px] w-full">
                <div className="flex flex-col">
                  ...
                  <div className="flex flex-col items-start justify-start w-full mt-5 mx-2">
              ...
              <div className="flex md:flex-1 flex-col gap-[27px] justify-start md:ml-[0] ml-[122px] w-1/4 md:w-full">
                <div className="flex flex-col gap-[17px] justify-start w-full">
                  ...
                  <Input
                    ...
                    className="p-0 pt-1 pl-1 placeholder:text-black-900_cc text-left text-sm w-full"
                    wrapClassName="flex w-full"
                    type="email"
                    suffix={
                      <Img
                        className="mt-px pt-1 mb-auto h-5 ml-[35px]"
